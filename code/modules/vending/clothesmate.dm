	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/under/misc/tanktop = 5,
				...
				/obj/item/clothing/under/misc/summerfit = 4,
				/obj/item/clothing/under/dress/sundress = 3,
				/obj/item/clothing/under/dress/tango = 3,
				/obj/item/clothing/under/dress/summerdress = 3,
				/obj/item/clothing/under/dress/longstriped = 3,
